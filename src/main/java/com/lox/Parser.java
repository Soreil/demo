...
public class Parser {
    ...
    // This exists to ignore the comma operator since it isn't valid in a call
    // context
    private Expr call_expression() {
        return ternary();
    }
    ...
    private Expr primary() {
        ...
        if (match(SLASH) || match(STAR) || match(QUESTION) || match(COLON) || match(AND) || match(OR)) {
