...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
        ...
        switch (expr.operator.type) {
            ...
            case PLUS:
                ...
                if (left instanceof Double && right instanceof String) {
                    return ((Double) left).toString() + right;
                }
                if (left instanceof String && right instanceof Double) {
                    return left + ((Double) right).toString();
                }
    ...
    public Object visitTernaryExpr(Ternary expr) {
        ...
        if (isTruthy(conditional)) {
            ...
            return evaluate(expr.falsehood);
        }
    }
    ...
    public Object visitExpressionStmtPrinting(Expression stmt) {
    ...
    public Void visitVarStmt(Var stmt) {
        ...
        if (stmt.initializer != null) {
            ...
            environment.defineInitialized(stmt.name.lexeme, value);
        } else {
